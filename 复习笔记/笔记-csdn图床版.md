...
![image-20230513152413896](https://img-blog.csdnimg.cn/d02488d296c04536bc60a1cdb6b1d1e5.jpeg)
...
* 冒烟测试/接口测试：软件构建版本建立后，对系统的基本功能进行简单的测试， 这种测试重点验证的是程序的**主要功能**，而不会对具体功能进行深入测试。
* 集成测试：冒烟测试之后，将已经测试过的软件单元组合在一起测试它们**之间的接口**，用于验证软件是否满足设计需求。
...
![image-20230513213645575](https://img-blog.csdnimg.cn/7344c021960545858953079715ed067b.jpeg)
...
1. 等价类表
   ...
   ![image-20230513091319670](https://img-blog.csdnimg.cn/f0d91a1132294d818e1d7ee050d5a860.jpeg)

2. 测试用例表

   1. 覆盖有效等价类

      ![image-20230513091624797](https://img-blog.csdnimg.cn/adc71036dadc49b387351d7d777306e8.jpeg)

   2. 覆盖无效等价类

      ![image-20230513091707194](https://img-blog.csdnimg.cn/e6bf1e5fa5f445a28570477a9cfa1ba7.jpeg)
...
1. 等价类表
   ...
   ![image-20230513092044646](https://img-blog.csdnimg.cn/97c55320e84f4090b8d73a53a9016fe3.jpeg)

2. 测试用例表

   1. 覆盖有效等价类

      ![image-20230513092222372](https://img-blog.csdnimg.cn/bb985b2589e04384a6becefb24687e56.jpeg)

   2. 覆盖无效等价类

      ![image-20230513092258958](https://img-blog.csdnimg.cn/bdd825d51cfb4b4a9f4343326a3a2d4a.jpeg)
...
![image-20230513092820815](https://img-blog.csdnimg.cn/a1db0ea69f82429da5b41b1b84f7cd4b.jpeg)

技巧※

![image-20230513093503394](https://img-blog.csdnimg.cn/1702668ca5fa409983063d9a3bada239.jpeg)
...
1. 三角形问题
   ...
   ![image-20230513093136015](https://img-blog.csdnimg.cn/8e989315b8464421a038cf56f4ccfd36.jpeg)
...
2. 余额宝提现的等价类划分
   ...
   ![image-20230513093932332](https://img-blog.csdnimg.cn/46ad4141a51143b1ba47d7e87eb38d7d.jpeg)

   ![image-20230513093943648](https://img-blog.csdnimg.cn/574fec991d8a4c6bbd5fd4086b3eae64.jpeg)

   ![image-20230513093954163](https://img-blog.csdnimg.cn/b21cbe6af5374f8fb8eb3ab644bc1d07.jpeg)
...
1. 三角形问题✦
   ...
   4. 决策表
      ...
      ![image-20230513094733596](https://img-blog.csdnimg.cn/6f587ee0250a4a4985a1972e8ede136a.jpeg)

   5. 化简后的决策表

      ![image-20230513094759708](https://img-blog.csdnimg.cn/ffcf864105ed44ee8ba2894e9fb5d224.jpeg)

   6. 测试样例

      ![image-20230513095007024](https://img-blog.csdnimg.cn/5fc8d4759d374f1c9b68f258af25ef6f.jpeg)
...
2. 工资发放决策表
   ...
   2. 原因和结果
      ...
      ![image-20230513100030639](https://img-blog.csdnimg.cn/bb5f9b14a5b54ddc852ec7b3df31b385.jpeg)

   3. 决策表

      ![image-20230513100052599](https://img-blog.csdnimg.cn/b455781f87304ad58e8cef098161b968.jpeg)

   4. 测试用例

      ![image-20230513100128696](https://img-blog.csdnimg.cn/2970d8cbffd34a9e8d923370199ae23c.jpeg)
...
![image-20230513100802347](https://img-blog.csdnimg.cn/b90d3e1dec174601a75df29b2a078826.jpeg)

若原因出现，则结果出现；若原因不出现，则结果也不出现。

非关系

![image-20230513100827583](https://img-blog.csdnimg.cn/4edd0321b8644f129091905423861fd6.jpeg)

若原因出现，则结果不出现；若原因不出现，则结果出现。

或关系

![image-20230513100912744](https://img-blog.csdnimg.cn/2d3b7bea360d4f1a99cf29fe5f86e2ab.jpeg)

若几个原因中有1个出现，则结果出现；若原因都不出现，则结果不出现。

与关系

![image-20230513101230298](https://img-blog.csdnimg.cn/48b82f606ec84805a4a16c3d52877476.jpeg)
...
![image-20230513101433226](https://img-blog.csdnimg.cn/5edb2b2cbe9e44669ed81284a6003c78.jpeg)

表示C1、C2两个原因不会同时成立，两个中最多有一个可能成立。

包含 （I）

![image-20230513101547666](https://img-blog.csdnimg.cn/d571e384d76f402eaeb3a371e4d8b672.jpeg)

表示C1、C2、C3这3个原因中至少有一个必须成立。

唯一 （O）

![image-20230513101622314](https://img-blog.csdnimg.cn/167b85b3c4bd4bcfad1e8c2dc38d6ce9.jpeg)

表示C1和C2当中必须有一个，且仅有一个成立。

要求 （R）

![image-20230513101755124](https://img-blog.csdnimg.cn/acbe734a95a94a5d97b5123216eea03d.jpeg)
...
![image-20230513101856056](https://img-blog.csdnimg.cn/632cb26aeea74921b683f45c472023fe.jpeg)
...
1. 来源：PPT和实验三
   ...
   2. 原因和结果
      ...
      | 编号 | 原因             | 编号 | 结果                                |
      | ---- | ---------------- | ---- | ----------------------------------- |
      | C1   | 第一个输入是‘*’  | R1   | 修改文件  （为了测试方便，输出‘T’） |
      | C2   | 第一个输入是‘#’  | R2   | 输出消息 N                          |
      | C3   | 第二个输入是数字 | R3   | 输出消息 M                          |

   3. 因果图

      ![image-20230513110330461](https://img-blog.csdnimg.cn/6052fa53420a46f1a8e530254b4bf46d.jpeg)
...
![image-20230513111724145](https://img-blog.csdnimg.cn/84137a6c11cd470782b4dc783e7ba13b.jpeg)
...
![image-20230513142809158](https://img-blog.csdnimg.cn/599b97f8696c4e5b87a8d8208c1be82f.jpeg)

设计尽可能少的测试用例，使得被测模块中每一条语句都至少执行一次。

##### 判定覆盖

![image-20230513143032686](https://img-blog.csdnimg.cn/ae0f1a0f899a4905803a7035c46f7f1a.jpeg)
...
![image-20230513144031510](https://img-blog.csdnimg.cn/22fdcdaeca8a47b4a99f0f062cfae0f8.jpeg)

条件覆盖(Condition Coverage)指的是设计足够多的测试用 例，使判定语句中的每个逻辑条件取真值与取假值至少出现一 次。

###### 测试样例

![image-20230513143404114](https://img-blog.csdnimg.cn/21d769d784674d6e9347e02b7ab9da7b.jpeg)
...
![image-20230513144357656](https://img-blog.csdnimg.cn/594a25b90703459ba734b168b5b05b93.jpeg)
...
![image-20230513144031510](https://img-blog.csdnimg.cn/8890af4c0a254156a5cbcff8a0a900f5.jpeg)
...
1. 方案一
   ...
   ![image-20230513145416745](https://img-blog.csdnimg.cn/e79d8d222b4f4cb9b71f795e4edfcdaa.jpeg)

2. 方案二

   ![image-20230513145432456](https://img-blog.csdnimg.cn/a8eb1c8c679d48928c3d177051bd9cd6.jpeg)
...
![image-20230513145519026](https://img-blog.csdnimg.cn/7466edd930d94acba60a5582b0b5d0a9.jpeg)
...
![image-20230513151132182](https://img-blog.csdnimg.cn/a34fec2f53534e2fb65c85a321cc49c2.jpeg)
...
1. 流程图
   ...
   ![image-20230513151342787](https://img-blog.csdnimg.cn/7242d32d76d04e0583cafa868a2ac7e2.jpeg)

2. 流图

   ![image-20230513151407625](https://img-blog.csdnimg.cn/2d7b9bd78f0f4d6b820bd188cc75b96b.jpeg)

3. 测试用例

   判定覆盖，使程序中每个判定语句至少有一次“真”值，至少有一 次“假”值

   ![image-20230513151506233](https://img-blog.csdnimg.cn/7651f6d840834a79946da2d425933b18.jpeg)

## 软件测试过程模型

### V模型

![image-20230514095526133](https://img-blog.csdnimg.cn/c2b21f6244d841ca9eadae8e2ef038b6.jpeg)
...
![image-20230514095830434](https://img-blog.csdnimg.cn/8fef7578d5754be9af2c322b83013f3d.jpeg)
...
![image-20230513154958716](https://img-blog.csdnimg.cn/96bc4f9e5df8498ebb91ae81a3599116.jpeg)
...
![image-20230513155805196](https://img-blog.csdnimg.cn/f8cbffd62a4b4fde98e1426d070fbc48.jpeg)
...
![image-20230513161950960](https://img-blog.csdnimg.cn/fba7588146b8490f9da6e7f458b5c380.jpeg)
...
自动化测试（automated test）是相对手工测试而存在的一个概念，由手工逐个地运行测试用例的操作过程被**测试工具**自动执行的过程所代替。

### 自动化测试流程★

![image-20230513162737111](https://img-blog.csdnimg.cn/0ed267d8d68a443e8ad52f38d66325bc.jpeg)
